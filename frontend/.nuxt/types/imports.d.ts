...
declare global {
  ...
  const useGameApi: typeof import('../../app/composables/useGameApi').useGameApi
  const useGameStore: typeof import('../../app/stores/game').useGameStore
  ...
  const useMinigameStore: typeof import('../../app/stores/minigame').useMinigameStore
...
declare global {
  ...
  // @ts-ignore
  export type { AdminUser, AdminGame, AdminReward, AdminTournament, LeaderboardEntry, GameConfigData, GameHistoryEntry } from '../../app/stores/auth'
  import('../../app/stores/auth')
  // @ts-ignore
  export type { Screen, Phase } from '../../app/stores/game'
  import('../../app/stores/game')
  // @ts-ignore
  export type { MinigameSession, MinigameScore, MinigameFinish } from '../../app/stores/minigame'
  import('../../app/stores/minigame')
}
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly useGameApi: UnwrapRef<typeof import('../../app/composables/useGameApi')['useGameApi']>
    readonly useGameStore: UnwrapRef<typeof import('../../app/stores/game')['useGameStore']>
    ...
    readonly useMinigameStore: UnwrapRef<typeof import('../../app/stores/minigame')['useMinigameStore']>

    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .exceptionHandling(ex -> ex
                        .authenticationEntryPoint((req, res, e) -> writeJsonError(res, 401, "authorization required"))
                        .accessDeniedHandler((req, res, e) -> writeJsonError(res, 403, "admin access required"))
                );
